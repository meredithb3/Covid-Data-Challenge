...
From the two graphs above, we can see that the normality assumption is [SATISFIED/NOT SATISFIED].

#### Independence

This is maybe not true? States and counties affect each other.
