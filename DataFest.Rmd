...
full_interaction <- lm(logDeathsPC ~ logCases + 
                    ...
                    log_pop_2015 + perc_white + perc_black + 
                      logCases*Rural.urban_Continuum_Code_2013 +
                      logCases*PCTPOVALL_2018 + logCases*perc_white +
                      logCases*perc_black +
                      Rural.urban_Continuum_Code_2013*perc_white + 
                      Rural.urban_Continuum_Code_2013*perc_black + 
                      Rural.urban_Continuum_Code_2013*PCTPOVALL_2018 + 
                      Rural.urban_Continuum_Code_2013*log_pop_2015 + 
...
We see that there does not seem to be any correlation between the residuals and the log(Deaths/Capita). Therefore, we assume that our model fits the constant variance assumption, and we will proceed to check normality of our model.
